...
- Analytics fixtures: `analytics/sample-events.jsonl`
...
To register metadata without importing fixture events:
...
- Version: `0.2.2`
- Optional synthetic analytics from `analytics/sample-events.jsonl`
